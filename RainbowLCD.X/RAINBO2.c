...
#include	"RAINBO2.h"			// For optional user variable definitions
...
void init(void)
{
	...
	OPTION_REG = 0b00101000;	// Weak pull-ups on, falling INT interrupt,
								// TRM0 internal from CPS, no prescaler
	...
	CPSCON0 = 0b10001001;		// Enable Cap Sense module, fixed reference, 
                                // medium current, CPS becomes TMR0 clock source
	CPSCON1 = 1;				// Select capacitive channel 1 (T1)
